...
contextBridge.exposeInMainWorld('electron', {
  ...
  loadContentFile: (contentFile: string) => ipcRenderer.invoke('load-content-file', contentFile),
  saveContentFile: (contentFile: string, content: string) => ipcRenderer.invoke('save-content-file', contentFile, content),
